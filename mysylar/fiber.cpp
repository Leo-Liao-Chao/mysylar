...
namespace mysylar
{
    ...
    Fiber::Fiber()
    {
        ...
        MYSYLAR_LOG_DEBUG(g_logger)<<" Fiber::Fiber";
    }
    ...
    void Fiber::MainFunc()
    {
        ...
        {
            cur->m_state =EXCEPT;
            MYSYLAR_LOG_ERROR(g_logger)<<" Fiber Execpt:  "<<e.what();
        }
        catch(...)
        {
            cur->m_state =EXCEPT;
            MYSYLAR_LOG_ERROR(g_logger)<<" Fiber Execpt";
        }
        ...
        MYSYLAR_ASSERT2(false,"never reach");
    }
