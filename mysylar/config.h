...
#ifndef __MYSYLAR_CONFIG_H__
#define __MYSYLAR_CONFIG_H__
...
namespace mysylar
{
    ...
    public:
        ...
        std::string toString() override
        {
            ...
            {
                MYSYLAR_LOG_ERROR(MYSYLAR_LOG_ROOT()) << "ConfigVar:toString exception" << e.what() << "convert: " << typeid(m_val).name() << "to string";
                // std::cerr << e.what() << '\n';
            }
            return "";
        }
        bool fromString(const std::string &val) override
        {
            ...
            {
                MYSYLAR_LOG_ERROR(MYSYLAR_LOG_ROOT()) << "ConfigVar:toString exception" << e.what() << "convert:string to " << typeid(m_val).name();
                // std::cerr << e.what() << '\n';
                return false;
            }
        }
    ...
    private:
        T m_val;
        // change callback group key,only one,use hash
    ...
    public:
        ...
        static typename ConfigVar<T>::ptr Lookup(const std::string &name, const T &default_value, const std::string &description = "")
        {
            ...
            if (it != GetDatas().end())
            {
                ...
                if (tmp)
                {
                    MYSYLAR_LOG_INFO(MYSYLAR_LOG_ROOT()) << "Lookup name=" << name << " exists" << std::endl;
                    return tmp;
                }
                else
                {
                    MYSYLAR_LOG_ERROR(MYSYLAR_LOG_ROOT()) << "Lookup name=" << name << " exists but type not " << typeid(T).name()
            ...
            {
                MYSYLAR_LOG_ERROR(MYSYLAR_LOG_ROOT()) << "Lookup name invalid " << std::endl;
