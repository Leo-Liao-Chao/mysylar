...
#undef XX
    ...
    mysylar::ConfigVar<std::set<LogDefine>>::ptr g_log_defines =
        mysylar::Config::Lookup("logs", std::set<LogDefine>(), "logs config");
                ...
                [](const std::set<LogDefine> &old_value, const std::set<LogDefine> &new_value)
                {
                    ...
                    for (auto &i : new_value)
                    {
                        ...
                        for (auto &a : i.appenders)
                        {
                            ...
                            {
                                if (!mysylar::EnvMgr::GetInstance()->has("d"))
                                {
